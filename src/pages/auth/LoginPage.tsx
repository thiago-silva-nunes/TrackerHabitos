      ...
      >
        ...
        <div className="bg-surface-1 rounded-2xl border border-foreground/6 p-6 space-y-5">
          <div>
            ...
            <p className="text-sm text-foreground/40 mt-0.5">Bem-vindo de volta!</p>
          </div>
          ...
          <p className="text-center text-sm text-foreground/40">
            Não tem conta?{" "}
            <Link to="/cadastro" className="text-habits hover:text-habits-light transition-colors font-medium">
              Criar conta
            </Link>
          </p>
        </div>
